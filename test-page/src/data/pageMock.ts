...
export const pageMock: PageMock = {
  tabs: [
    { id: 'all', label: 'ทั้งหมด', count: 48, active: true },
  ...
  products: [
    ...
    // Additional Non-Discounted Tires for Balance

    // Honda Accord 2025 - 225/50R17 (Non-discounted)
    {
      id: 'goodyear-efficientgrip-accord',
      brand: 'Goodyear',
      name: 'Goodyear EfficientGrip Performance',
      image: '/images/goodyear-efficientgrip.png',
      rating: 4.7,
      reviews: 834,
      attributes: { comfort: 4, handling: 4, fuelEconomy: 5, durability: 4, noise: 4 },
      tags: ['ประหยัดน้ำมัน'],
    ...
    {
      id: 'pirelli-cinturato-accord',
      brand: 'Pirelli',
      name: 'Pirelli Cinturato P7',
      image: '/images/pirelli-cinturato.png',
      rating: 4.6,
      reviews: 567,
      attributes: { comfort: 4, handling: 4, fuelEconomy: 4, durability: 4, noise: 4 },
      tags: ['Run Flat'],
    ...
    // Toyota Corolla 2020 - 195/65R15 (Non-discounted)
    {
      id: 'hankook-kinergy-corolla',
      brand: 'Hankook',
      name: 'Hankook Kinergy Eco2',
      image: '/images/hankook-kinergy.png',
      rating: 4.5,
      reviews: 423,
      attributes: { comfort: 4, handling: 4, fuelEconomy: 5, durability: 4, noise: 4 },
      tags: ['ประหยัดน้ำมัน'],
    ...
    {
      id: 'kumho-solus-corolla',
      brand: 'Kumho',
      name: 'Kumho Solus TA31',
      image: '/images/kumho-solus.png',
      rating: 4.4,
      reviews: 298,
      attributes: { comfort: 4, handling: 4, fuelEconomy: 4, durability: 4, noise: 3 },
      tags: [],
    ...
    // BMW 3 Series 2019 - 225/45R18 (Non-discounted)
    {
      id: 'goodyear-eagle-bmw',
      brand: 'Goodyear',
      name: 'Goodyear Eagle F1 Asymmetric 5',
      image: '/images/goodyear-eagle.png',
      rating: 4.8,
      reviews: 756,
      attributes: { comfort: 4, handling: 5, fuelEconomy: 3, durability: 4, noise: 4 },
      tags: ['Performance'],
    ...
    {
      id: 'pirelli-pzero-bmw',
      brand: 'Pirelli',
      name: 'Pirelli P Zero',
      image: '/images/pirelli-pzero.png',
      rating: 4.7,
      reviews: 634,
      attributes: { comfort: 4, handling: 5, fuelEconomy: 3, durability: 4, noise: 3 },
      tags: ['Performance'],
    ...
    // Tesla Model 3 2022 - 235/45R18 (Non-discounted)
    {
      id: 'goodyear-efficientgrip-tesla',
      brand: 'Goodyear',
      name: 'Goodyear EfficientGrip Performance 2',
      image: '/images/goodyear-efficientgrip2.png',
      rating: 4.6,
      reviews: 523,
      attributes: { comfort: 4, handling: 4, fuelEconomy: 5, durability: 4, noise: 4 },
      tags: ['รถ EV', 'ประหยัดน้ำมัน'],
    ...
    {
      id: 'hankook-ion-tesla',
      brand: 'Hankook',
      name: 'Hankook iON evo AS',
      image: '/images/hankook-ion.png',
      rating: 4.7,
      reviews: 445,
      attributes: { comfort: 5, handling: 4, fuelEconomy: 5, durability: 4, noise: 5 },
      tags: ['รถ EV'],
      price: 5200,
      currency: '฿',
      compatibleTireSize: '235/45R18',
    ...
    // Honda Civic 2018 - 215/55R16 (Non-discounted)
    {
      id: 'kumho-solus-civic',
      brand: 'Kumho',
      name: 'Kumho Solus HS51',
      image: '/images/kumho-solus-hs.png',
      rating: 4.5,
      reviews: 389,
      attributes: { comfort: 4, handling: 4, fuelEconomy: 4, durability: 4, noise: 4 },
      tags: [],
    ...
    {
      id: 'goodyear-assurance-civic',
      brand: 'Goodyear',
      name: 'Goodyear Assurance ComfortDrive',
      image: '/images/goodyear-assurance.png',
      rating: 4.6,
      reviews: 512,
      attributes: { comfort: 5, handling: 4, fuelEconomy: 4, durability: 4, noise: 5 },
      tags: [],
      price: 2950,
      currency: '฿',
      compatibleTireSize: '215/55R16',
    ...
    // Mazda CX-5 2021 - 225/55R19 (Non-discounted)
    {
      id: 'pirelli-scorpion-cx5',
      brand: 'Pirelli',
      name: 'Pirelli Scorpion Verde',
      image: '/images/pirelli-scorpion.png',
      rating: 4.6,
      reviews: 467,
      attributes: { comfort: 4, handling: 4, fuelEconomy: 4, durability: 5, noise: 4 },
      tags: ['SUV'],
    ...
    {
      id: 'hankook-dynapro-cx5',
      brand: 'Hankook',
      name: 'Hankook Dynapro HP2',
      image: '/images/hankook-dynapro.png',
      rating: 4.5,
      reviews: 398,
      attributes: { comfort: 4, handling: 4, fuelEconomy: 4, durability: 5, noise: 3 },
      tags: ['SUV'],
      price: 4100,
      currency: '฿',
      compatibleTireSize: '225/55R19',
    ...
    // Nissan Navara 2017 - 265/60R18 (Non-discounted)
    {
      id: 'kumho-roadventure-navara',
      brand: 'Kumho',
      name: 'Kumho Road Venture AT52',
      image: '/images/kumho-roadventure.png',
      rating: 4.4,
      reviews: 345,
      attributes: { comfort: 3, handling: 4, fuelEconomy: 3, durability: 5, noise: 3 },
      tags: ['All Terrain', 'Pickup'],
    ...
    {
      id: 'goodyear-wrangler-navara',
      brand: 'Goodyear',
      name: 'Goodyear Wrangler AT',
      image: '/images/goodyear-wrangler.png',
      rating: 4.5,
      reviews: 423,
      attributes: { comfort: 3, handling: 4, fuelEconomy: 3, durability: 5, noise: 3 },
      tags: ['All Terrain', 'Pickup'],
    ...
    // Toyota Camry Hybrid 2024 - 215/55R17 (Non-discounted)
    {
      id: 'hankook-kinergy-camry',
      brand: 'Hankook',
      name: 'Hankook Kinergy Eco2 K435',
      image: '/images/hankook-kinergy-k435.png',
      rating: 4.6,
      reviews: 534,
      attributes: { comfort: 4, handling: 4, fuelEconomy: 5, durability: 4, noise: 4 },
      tags: ['Hybrid', 'ประหยัดน้ำมัน'],
    ...
    {
      id: 'kumho-ecsta-camry',
      brand: 'Kumho',
      name: 'Kumho Ecsta HS52',
      image: '/images/kumho-ecsta.png',
      rating: 4.5,
      reviews: 412,
      attributes: { comfort: 4, handling: 4, fuelEconomy: 4, durability: 4, noise: 4 },
      tags: ['Hybrid'],
    ...
    // Ford Ranger Wildtrak 2016 - 265/65R17 (Non-discounted)
    {
      id: 'pirelli-scorpion-ranger',
      brand: 'Pirelli',
      name: 'Pirelli Scorpion ATR',
      image: '/images/pirelli-scorpion-atr.png',
      rating: 4.4,
      reviews: 378,
      attributes: { comfort: 3, handling: 4, fuelEconomy: 3, durability: 5, noise: 3 },
      tags: ['Highway Terrain', 'Pickup'],
    ...
    {
      id: 'hankook-dynapro-ranger',
      brand: 'Hankook',
      name: 'Hankook Dynapro AT2',
      image: '/images/hankook-dynapro-at2.png',
      rating: 4.3,
      reviews: 289,
      attributes: { comfort: 3, handling: 3, fuelEconomy: 4, durability: 5, noise: 3 },
      tags: ['Highway Terrain', 'Pickup'],
      price: 3300,
      currency: '฿',
      compatibleTireSize: '265/65R17',
    ...
    // Mercedes-Benz C200 2023 - 225/50R17 (Non-discounted)
    {
      id: 'goodyear-eagle-c200',
      brand: 'Goodyear',
      name: 'Goodyear Eagle F1 Asymmetric 6',
      image: '/images/goodyear-eagle-f1.png',
      rating: 4.8,
      reviews: 678,
      attributes: { comfort: 5, handling: 5, fuelEconomy: 4, durability: 4, noise: 5 },
      tags: ['Premium'],
    ...
    {
      id: 'pirelli-pzero-c200',
      brand: 'Pirelli',
      name: 'Pirelli P Zero PZ4',
      image: '/images/pirelli-pzero-pz4.png',
      rating: 4.7,
      reviews: 567,
      attributes: { comfort: 5, handling: 5, fuelEconomy: 4, durability: 4, noise: 4 },
      tags: ['Premium'],
